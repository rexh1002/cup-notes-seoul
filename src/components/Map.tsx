...
export default function Map({
  ...
  return (
    ...
    >
      {selectedCafe && (
        <div className="absolute top-10 left-3 z-50 bg-white rounded-lg shadow-lg w-[calc(100%-24px)] sm:w-[328px] max-h-[calc(100vh-236px)] flex flex-col overflow-hidden">
          {/* 카페 이미지 섹션 */}
